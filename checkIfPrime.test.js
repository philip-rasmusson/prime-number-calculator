...
//   expect(checkIfPrime(1010747041)).toEqual(true)
//   expect(checkIfPrime(1010747045)).toEqual(false)
// })

test('', () => {
  expect(findNextPrime(2)).toBe(3)
  expect(findNextPrime(3)).toBe(5)
  expect(findNextPrime(131)).toBe(137)
  expect(findNextPrime(1279)).toBe(1283)
  expect(findNextPrime(3221)).toBe(3229)
  expect(findNextPrime(100000049)).toBe(100000073)
})